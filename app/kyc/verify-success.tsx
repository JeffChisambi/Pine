...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: "Inter_700Bold", fontSize: 24, color: DARK, textAlign: "center" },
  subtitle: { fontFamily: "Inter_400Regular", fontSize: 15, color: MUTED, textAlign: "center", lineHeight: 24 },
  stepsCard: {
  ...
  stepsTitle: { fontFamily: "Inter_600SemiBold", fontSize: 13, color: MUTED, marginBottom: 10, textTransform: "uppercase", letterSpacing: 0.5 },
  stepItem: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 8 },
  stepCheck: {},
  stepLabel: { fontFamily: "Inter_500Medium", fontSize: 14, color: DARK },
  ...
  timeText: { fontFamily: "Inter_400Regular", fontSize: 13, color: "#92400E" },
  ...
  doneBtnText: { fontFamily: "Inter_600SemiBold", fontSize: 16, color: WHITE },
});
