...
function SuccessIllustration({ primaryColor }: { primaryColor: string }) {
  return (
...
export default function VerifySuccessScreen() {
  ...
  const styles = StyleSheet.create({
    ...
    doneBtn: { backgroundColor: c.primary, borderRadius: 12, paddingVertical: 18, alignItems: "center" },
  ...
  return (
    <View style={[styles.root, { paddingTop: topPad }]}>
      <View style={styles.content}>
        <SuccessIllustration primaryColor={c.primary} />
