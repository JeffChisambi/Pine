...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 24, color: DARK, textAlign: "center" },
  subtitle: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 15, color: MUTED, textAlign: "center", lineHeight: 24 },
  stepsCard: {
  ...
  stepsTitle: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 13, color: MUTED, marginBottom: 10, textTransform: "uppercase", letterSpacing: 0.5 },
  stepItem: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 8 },
  stepCheck: {},
  stepLabel: { fontFamily: "PlusJakartaSans_500Medium", fontSize: 14, color: DARK },
