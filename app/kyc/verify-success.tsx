  ...
  return (
    <View style={styles.successContainer}>
      <Svg width={139} height={130} viewBox="0 0 139 130" fill="none">
        ...
        {/* Right: light green name bar + data lines */}
        ...
        {/* Bottom light-green bar + wavy line */}
...
function StepItem({ step, label }: { step: string; label: string }) {
  return (
    ...
    <View style={[styles.root, { paddingTop: topPad }]}>
      <View style={styles.content}>
        ...
        <View style={styles.stepsCard}>
          ...
          <StepItem step="1" label="Photo ID (Front & Back)" />
          <View style={styles.stepDivider} />
          <StepItem step="2" label="Selfie Verification" />
        </View>
...
const styles = StyleSheet.create({
  ...
  successContainer: { alignItems: "center", justifyContent: "center", marginVertical: 8 },
  textBlock: { gap: 10, alignItems: "center" },
  title: { fontFamily: "Poppins_700Bold", fontSize: 24, color: DARK, textAlign: "center" },
  subtitle: { fontFamily: "Poppins_400Regular", fontSize: 15, color: MUTED, textAlign: "center", lineHeight: 24 },
  stepsCard: {
  ...
  stepsTitle: { fontFamily: "Poppins_600SemiBold", fontSize: 13, color: MUTED, marginBottom: 10, textTransform: "uppercase", letterSpacing: 0.5 },
  stepItem: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 8 },
  stepCheck: {},
  stepLabel: { fontFamily: "Poppins_500Medium", fontSize: 14, color: DARK },
  stepDivider: { height: 1, backgroundColor: CARD_BORDER, marginLeft: 28 },
  timeBox: {
    backgroundColor: "#FFFBEB",
    borderRadius: 10,
    padding: 14,
  },
  timeText: { fontFamily: "Poppins_400Regular", fontSize: 13, color: "#92400E" },
  ...
  doneBtnText: { fontFamily: "Poppins_600SemiBold", fontSize: 16, color: WHITE },
});
