...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: "Poppins_700Bold", fontSize: 18, color: DARK },
  ...
  uploadLabel: { fontFamily: "Poppins_600SemiBold", fontSize: 14, color: DARK },
  uploadLabelDone: { color: "#166534" },
  uploadHint: { fontFamily: "Poppins_400Regular", fontSize: 12, color: MUTED },
  tipBox: {
    flexDirection: "row",
    gap: 10,
  ...
  tipText: { flex: 1, fontFamily: "Poppins_400Regular", fontSize: 13, color: TEAL, lineHeight: 20 },
  ...
  continueBtnText: { fontFamily: "Poppins_600SemiBold", fontSize: 16, color: WHITE },
});
