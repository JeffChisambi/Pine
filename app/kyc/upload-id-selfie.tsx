...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: "Inter_700Bold", fontSize: 18, color: WHITE },
  viewfinder: {
    flex: 1,
    alignItems: "center",
  ...
  viewfinderHint: { fontFamily: "Inter_500Medium", fontSize: 14, color: "rgba(255,255,255,0.7)" },
  faceFrameOuter: {
    borderRadius: 20,
    overflow: "hidden",
    alignItems: "center",
  ...
  tipText: { fontFamily: "Inter_400Regular", fontSize: 12, color: MUTED },
  footer: { gap: 12 },
  captureBtn: { backgroundColor: TEAL, borderRadius: 12, paddingVertical: 18, alignItems: "center" },
  captureBtnDone: { backgroundColor: GREEN },
  captureBtnText: { fontFamily: "Inter_600SemiBold", fontSize: 16, color: WHITE },
  retakeBtn: { alignItems: "center", paddingVertical: 12 },
  retakeBtnText: { fontFamily: "Inter_500Medium", fontSize: 14, color: TEAL },
  processingContainer: { alignItems: "center", gap: 12, paddingVertical: 16 },
  processingText: { fontFamily: "Inter_600SemiBold", fontSize: 16, color: DARK },
  processingSubText: { fontFamily: "Inter_400Regular", fontSize: 13, color: MUTED },
});
