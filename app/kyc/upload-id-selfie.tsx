...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 18, color: WHITE },
  viewfinder: {
    flex: 1,
    alignItems: "center",
  ...
  viewfinderHint: { fontFamily: "PlusJakartaSans_500Medium", fontSize: 14, color: "rgba(255,255,255,0.7)" },
  faceFrameOuter: {
    borderRadius: 20,
    overflow: "hidden",
    alignItems: "center",
  ...
  tipText: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 12, color: MUTED },
  footer: { gap: 12 },
  captureBtn: { backgroundColor: TEAL, borderRadius: 12, paddingVertical: 18, alignItems: "center" },
  captureBtnDone: { backgroundColor: GREEN },
  captureBtnText: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 16, color: WHITE },
  retakeBtn: { alignItems: "center", paddingVertical: 12 },
  retakeBtnText: { fontFamily: "PlusJakartaSans_500Medium", fontSize: 14, color: TEAL },
  processingContainer: { alignItems: "center", gap: 12, paddingVertical: 16 },
  processingText: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 16, color: DARK },
  processingSubText: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 13, color: MUTED },
});
