...
// ─── Icons — untouched ────────────────────────────────────────────────────────
function IdIcon({ tealColor }: { tealColor: string }) {
  return (
    <Svg width={40} height={40} viewBox="0 0 40 40" fill="none">
      <G clipPath="url(#clip0_3132_11307)">
        ...
        <Circle cx={20} cy={21} r={8} fill={tealColor} />
...
function PassportIcon({ tealColor }: { tealColor: string }) {
  return (
    <Svg width={40} height={40} viewBox="0 0 40 40" fill="none">
      <G clipPath="url(#clip_passport)">
        <Rect width={40} height={40} rx={20} fill="#2D5B62" />
        <Rect x={6} y={12} width={28} height={20} rx={2} fill="#FFFFFF" />
        <Rect x={19.5} y={12} width={1} height={20} fill={tealColor} opacity={0.25} />
        <Rect x={9} y={15} width={5} height={6} rx={1} fill={tealColor} />
        <Rect x={9} y={23} width={7} height={1.5} rx={0.75} fill={tealColor} />
        <Rect x={9} y={26} width={5} height={1.5} rx={0.75} fill={tealColor} />
        <Rect x={22} y={15} width={9} height={1.5} rx={0.75} fill={tealColor} />
        <Rect x={22} y={19} width={7} height={1.5} rx={0.75} fill={tealColor} />
        <Rect x={22} y={23} width={8} height={1.5} rx={0.75} fill={tealColor} />
        <Rect x={22} y={27} width={5} height={1.5} rx={0.75} fill={tealColor} />
      </G>
      <Defs>
...
export default function ProofOfResidencyScreen() {
  ...
  const styles = StyleSheet.create({
    ...
    docRowActive: { backgroundColor: c.primary },
              ...
              <View key={doc.id}>
                ...
                >
                  <View style={[styles.docIconWrap, isActive && styles.docIconWrapActive]}>
                    {doc.id === "national_id" ? <IdIcon tealColor={c.primary} /> : <PassportIcon tealColor={c.primary} />}
                  </View>
