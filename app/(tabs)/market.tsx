...
function SectorAgricultureIcon({ color }: { color: string }) {
  return (
    <Svg width={22} height={22} viewBox="0 0 24 24" fill="none">
      <Path d="M20 8.55V8.5a4.5 4.5 0 0 0-4.27-4.49C14.9 2.77 13.5 2 12 2s-2.91.77-3.73 2.01A4.51 4.51 0 0 0 4 8.5v.05c-1.22.7-2 2.01-2 3.45 0 2.41 2.15 4.37 4.62 3.95.19.16.4.3.61.42 3.65 2.84 3.76 5.53 3.76 5.64h2c0-.11.11-2.79 3.73-5.61.23-.13.44-.28.65-.45 2.48.42 4.62-1.53 4.62-3.95 0-1.44-.78-2.75-2-3.45Z" fill={color} />
    </Svg>
  );
}
