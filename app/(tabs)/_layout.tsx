...
function HomeIcon({ color }: { color: string }) {
  ...
  return (
    <Svg width={24} height={24} viewBox="0 0 24 24" fill="none">
      {active && (
        <Path d="M12.75 17.9999C12.75 18.4099 12.41 18.7499 12 18.7499C11.59 18.7499 11.25 18.4099 11.25 17.9999V14.9999C11.25 14.5899 11.59 14.2499 12 14.2499C12.41 14.2499 12.75 14.5899 12.75 14.9999V17.9999Z" fill="#FFFFFF" />
      )}
      <Path
