          ...
          <View style={{ paddingHorizontal: 20, marginTop: 28 }}>
            ...
            >
              <View style={{
                ...
                {/* Left: text content */}
                <View style={{ flex: 1, gap: 6 }}>
                  <Text style={{ fontFamily: "PlusJakartaSans_500Medium", fontSize: 12, color: "rgba(255,255,255,0.75)", letterSpacing: 0.3 }}>Education</Text>
                  ...
                  <View style={{ gap: 3, marginTop: 2 }}>
                    {["Basics", "Portfolio", "Charts", "Risk"].map((topic) => (
                      <View key={topic} style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
                        ...
                        <Text style={{ fontFamily: "PlusJakartaSans_400Regular", fontSize: 13, color: WHITE }}>{topic}</Text>
                      </View>
                    ))}
                  </View>
                </View>
