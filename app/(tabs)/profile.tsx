...
function LockIcon({ color }: { color: string }) {
  return (
    <Svg width={22} height={22} viewBox="0 0 22 22" fill="none">
      <Path d="M14.4375 8.9375V4.85547C14.4375 3.94379 14.0753 3.06945 13.4307 2.42479C12.786 1.78013 11.9117 1.41797 11 1.41797C10.0883 1.41797 9.21398 1.78013 8.56932 2.42479C7.92466 3.06945 7.5625 3.94379 7.5625 4.85547V8.9375" stroke={color} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M15.8125 8.9375H6.1875C5.04841 8.9375 4.125 9.86091 4.125 11V18.5625C4.125 19.7016 5.04841 20.625 6.1875 20.625H15.8125C16.9516 20.625 17.875 19.7016 17.875 18.5625V11C17.875 9.86091 16.9516 8.9375 15.8125 8.9375Z" stroke={color} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
...
function FingerprintIcon({ color }: { color: string }) {
  return (
    <Svg width={22} height={22} viewBox="0 0 22 22" fill="none">
      <Path d="M16.7759 3.23474C14.6403 2.15193 12.9916 1.7188 11.015 1.7188C9.04836 1.7188 7.18094 2.20349 5.48238 3.17286C5.24219 3.30865 4.94613 3.21411 4.80692 2.9649C4.74478 2.84461 4.73076 2.70518 4.76771 2.57493C4.80466 2.44468 4.88981 2.33338 5.00586 2.26365C6.83778 1.22465 8.909 0.681407 11.015 0.687552C13.1304 0.687552 14.978 1.17224 17.0045 2.25505C17.2129 2.94599 16.7759 3.23474 16.7759 3.23474ZM2.56223 8.6488C2.16479 8.47458 2.09112 8.35383 2.06884 8.21917C2.04656 8.08452 2.0774 7.94647 2.15488 7.83411C3.13844 6.39036 4.38926 5.25599 5.87985 4.46193C8.99852 2.79302 12.9916 2.78099 16.1202 4.45161C17.6103 5.24568 18.8616 6.36974 19.8451 7.80318C19.9223 7.91564 19.9529 8.0536 19.9307 8.18815C19.9084 8.32271 19.8349 8.44344 19.7257 8.52505C19.5122 8.61384 19.2861 8.52505 19.0304 8.4013C18.1367 7.10193 17.0045 6.08099 15.6634 5.36943C12.8129 3.85349 9.16738 3.85349 6.32672 5.37974C4.97578 6.10161 3.84356 7.13286 2.94981 8.43052C2.71814 8.63219 2.6406 8.65124 2.56223 8.6488Z" fill={color} />
    </Svg>
  );
}
...
function SealCheckIcon({ color }: { color: string }) {
  return (
    <Svg width={22} height={22} viewBox="0 0 24 24" fill="none">
      <Path d="M19 9.09V6c0-.55-.45-1-1-1h-3.09L12.7 2.79a.996.996 0 0 0-1.41 0L9.08 5H5.99c-.55 0-1 .45-1 1v3.09L2.78 11.3a.996.996 0 0 0 0 1.41l2.21 2.21v3.09c0 .55.45 1 1 1h3.09l2.21 2.21c.2.2.45.29.71.29s.51-.1.71-.29l2.21-2.21h3.09c.55 0 1-.45 1-1v-3.09l2.21-2.21a.996.996 0 0 0 0-1.41L19 9.09Z" fill={color} />
      <Path d="m11 12.59-1.29-1.3-1.42 1.42 2.71 2.7 4.71-4.7-1.42-1.42z" fill={color} />
    </Svg>
  );
}
