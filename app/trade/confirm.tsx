...
const styles = StyleSheet.create({
  ...
  assetLogoText: { fontFamily: "Poppins_700Bold", fontSize: 16, color: WHITE },
  orderHeaderInfo: { flex: 1 },
  orderAssetName: { fontFamily: "Poppins_600SemiBold", fontSize: 15, color: DARK, marginBottom: 3 },
  orderAssetTicker: { fontFamily: "Poppins_400Regular", fontSize: 13, color: MUTED },
  orderStatusBadge: {
  ...
  orderStatusText: { fontFamily: "Poppins_500Medium", fontSize: 12, color: "#92400E" },
  summaryCard: {
    backgroundColor: CARD_BG,
    borderRadius: 14,
    borderWidth: 1,
  ...
  summaryValue: { fontFamily: "Poppins_500Medium", fontSize: 13, color: DARK },
  sectionLabel: {
    fontFamily: "Poppins_600SemiBold",
    fontSize: 14,
    color: DARK,
  ...
  paymentInfo: { flex: 1 },
  paymentLabel: { fontFamily: "Poppins_500Medium", fontSize: 14, color: DARK, marginBottom: 2 },
  paymentSub: { fontFamily: "Poppins_400Regular", fontSize: 12, color: MUTED },
  changeText: { fontFamily: "Poppins_500Medium", fontSize: 13, color: TEAL },
  promoApplied: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  promoAppliedText: { fontFamily: "Poppins_400Regular", fontSize: 13, color: MUTED },
  savingCard: {
    flexDirection: "row",
    alignItems: "center",
  ...
  savingLeft: { flex: 1 },
  savingTitle: { fontFamily: "Poppins_600SemiBold", fontSize: 14, color: DARK, marginBottom: 2 },
  savingDesc: { fontFamily: "Poppins_400Regular", fontSize: 12, color: MUTED },
  totalCard: {
    backgroundColor: CARD_BG,
    borderRadius: 14,
    borderWidth: 1,
  ...
  totalLabel: { fontFamily: "Poppins_400Regular", fontSize: 13, color: MUTED },
  totalValue: { fontFamily: "Poppins_500Medium", fontSize: 13, color: DARK },
  totalFinalLabel: { fontFamily: "Poppins_700Bold", fontSize: 15, color: DARK },
  totalFinalValue: { fontFamily: "Poppins_700Bold", fontSize: 15, color: TEAL },
  disclaimer: {
